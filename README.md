...
Режим BLE-конфигурации включается удержанием двух крайних кнопок в течение
двух секунд. После этого устройство одну минуту принимает второе BLE-подключение
от web-конфигуратора, не разрывая основное HID-подключение.
